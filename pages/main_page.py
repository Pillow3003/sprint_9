...
class MainPage(BasePage):
    ...
    @allure.step('Проверка появления текста "войти" на главной странице')
    ...
    @allure.step('Получить текст на кнопке "Войти" на главной странице')
    ...
    @allure.step('Получить текст на кнопке "Выход" (логアウト)')
    ...
    @allure.step('Проверка текста раздела "Рецепты" на главной странице')
